    ...
    public class NinjectControllerFactory : DefaultControllerFactory
    {
        ...
        private void AddBindings()
        {
            ...
            mock.Setup(m => m.DatabaseQueryResults).Returns(new List<DatabaseQueryResult> 
            {
                ...
                { 
                    QueryResult_Contractor = new Contractor("Manthis","Ostrowiec","27-400","Rosochy","Swietokrzyskie","123312323","3343244","www.ww.pl","sda@as.pl","Strawczynski","dostawca","betony; zaprawy; zaprawy szamotowe")
                },

                new DatabaseQueryResult 
                { 
                    QueryResult_Foundy = new Foundry("Odlewnia Ostrowiec","","","","","","","http://www.andoria-mot.com.pl/","sdasd@sda.pl","","",
                    new List<Material>
                    { 
                ...
                new DatabaseQueryResult 
                { 
                    QueryResult_Patent = new Patent(9384724, null,null,Convert.ToDateTime(DateTime.Now.ToShortDateString()),
                ...
                new DatabaseQueryResult 
                { 
                    QueryResult_Publication = new Publication(DateTime.Now.Date,"asdsads","asdasd","dasdasdassadssa asdasd asdasd","","czasopismo",
                    new List<Author>
                    {
                        new Author("John", "Newman", "AGH", "dr")
                    })
