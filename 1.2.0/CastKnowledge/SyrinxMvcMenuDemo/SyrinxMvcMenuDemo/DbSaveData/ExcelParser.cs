        ...
        private static List<PairDataTemplate<Patenty, List<string>>> ReadPatentData()
        {
            ...
            for (int index = 2; index <= lastRow; index++)
            {
                try
                {
                    ...
                    {
                        patentKeyWords = Container.SeparateKeyWords(myValues.GetValue(1, 12).ToString());
                    }
        ...
        private static List<PairDataTemplate<Publikacje, List<string>>> ReadPublicationData()
        {
            ...
            for (int index = 2; index <= lastRow; index++)
            {
                try
                {
                    ...
                    {
                        publicationKeyWords = Container.SeparateKeyWords(myValues.GetValue(1, 8).ToString());
                    }
        ...
        private static List<PairDataTemplate<Odlewnia, List<string>>> ReadFoundryData()
        {
            ...
            for (int index = 2; index <= lastRow; index++)
            {
                try
                {
                    ...
                    {
                        foundryKeyWords = Container.SeparateKeyWords(myValues.GetValue(1, 11).ToString());
                    }
        ...
        private static List<PairDataTemplate<Dostawca, List<string>>> ReadContractorData()
        {
            ...
            for (int index = 2; index <= lastRow; index++)
            {
                try
                {
                    ...
                    List<string> moKeyWords = Container.SeparateKeyWords(myValues.GetValue(1, 13).ToString());
